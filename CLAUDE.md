...
|-------------|------|---------------|-------------|
| sample-clean-ms | `modules/sample-clean-ms` | `modules/sample-clean-ms/AGENTS.md + CLAUDE.md` | Clean-architecture / CQRS reference microservice — Java 21 / Spring Boot 4 / MyBatis / MySQL |
...
|-----------------|------|-------------|
| clean | `readonly-dependencies/clean` | Internal `com.icecode.clean` framework — Java 21 / Spring Boot 4 / Maven multi-module |
